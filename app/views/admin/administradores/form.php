<?php
$admin = $administrador ?? [];
$nome = old('nome', (string) ($admin['nome'] ?? ''));
$telefone = old('telefone', (string) ($admin['telefone'] ?? ''));
$email = old('email', (string) ($admin['email'] ?? ''));
$status = old('status', (string) ($admin['status'] ?? 'ativo'));
