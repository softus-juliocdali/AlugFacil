    ...
    <div class="auth-shell">
        ...
        <div class="auth-card auth-card-wide">
            ...
            <form method="post" action="<?= url('/cadastro') ?>">
                <?= csrf_field() ?>
                <label>Nome completo<input type="text" name="nome" value="<?= e(old('nome', '', 'auth')) ?>" autocomplete="name" required minlength="2"></label>
                <div class="auth-fields-row">
                    <label>Telefone<input type="tel" name="telefone" value="<?= e(old('telefone', '', 'auth')) ?>" placeholder="(11) 99999-9999" autocomplete="tel"></label>
                    <label>E-mail<input type="email" name="email" value="<?= e(old('email', '', 'auth')) ?>" autocomplete="email" required></label>
                </div>
                <div class="auth-fields-row">
