<nav class="sidebar-nav">
    ...
    <a class="<?= is_active('/admin/mensalidades') ?>" href="<?= url('/admin/mensalidades') ?>"><span>&#36;</span> Mensalidades</a>
    ...
    <a class="<?= is_active('/admin/usuarios') ?>" href="<?= url('/admin/usuarios') ?>"><span>&#9812;</span> Clientes (usuários)</a>
    <a class="<?= is_active('/admin/afiliados') ?>" href="<?= url('/admin/afiliados') ?>"><span>&#9733;</span> Afiliados</a>
    <a class="<?= is_active('/admin/administradores') ?>" href="<?= url('/admin/administradores') ?>"><span>&#9881;</span> Administradores</a>
    <a class="<?= is_active('/admin/configuracoes-financeiras') ?>" href="<?= url('/admin/configuracoes-financeiras') ?>"><span>&#36;</span> Taxa</a>
    ...
    <a href="<?= url('/cliente/historico') ?>"><span>&#9633;</span> Minhas reservas como Hóspede</a>
